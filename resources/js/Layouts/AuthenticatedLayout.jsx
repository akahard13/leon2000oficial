            ...
            <nav className="bg-white border-b border-gray-100">
                        ...
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link href="/admin/dashboard">
                                    <img src={Logo} className="block h-10 w-auto" />
                                </Link>
                            </div>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={route('informacion_financiera')} active={route().current('informacion_financiera')}>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('informacion_financiera')} active={route().current('informacion_financiera')}>
                            Información Financiera
                        </ResponsiveNavLink>
                    </div>
